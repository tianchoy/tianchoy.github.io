import{_ as a,c as n,o as i,ag as l}from"./chunks/framework.BJQRJOxx.js";const d=JSON.parse('{"title":"flutter-firebase-login登陆失败","description":"","frontmatter":{},"headers":[],"relativePath":"list/dart/flutter-firebase-login登陆失败.md","filePath":"list/dart/flutter-firebase-login登陆失败.md","lastUpdated":1737442019000}'),e={name:"list/dart/flutter-firebase-login登陆失败.md"};function p(r,s,t,h,c,b){return i(),n("div",null,s[0]||(s[0]=[l(`<h1 id="flutter-firebase-login登陆失败" tabindex="-1">flutter-firebase-login登陆失败 <a class="header-anchor" href="#flutter-firebase-login登陆失败" aria-label="Permalink to &quot;flutter-firebase-login登陆失败&quot;">​</a></h1><p>用flutter+firebase做推送功能的时候，根据firebase文档提示做，安装好 cli之后，怎么用科学上网都登陆不上去， 然后，在sf找到一些办法，试过之后，生效了。记录一下</p><div class="language-dart vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">dart</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//1.执行命令,不出意外会报错</span></span>
