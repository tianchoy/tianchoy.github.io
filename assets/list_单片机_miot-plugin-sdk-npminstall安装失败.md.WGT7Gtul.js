import{_ as n,o as e,c as a,R as t}from"./chunks/framework.o-1c6b6b.js";const u=JSON.parse('{"title":"miot-plugin-sdk-npm install安装失败","description":"","frontmatter":{},"headers":[],"relativePath":"list/单片机/miot-plugin-sdk-npminstall安装失败.md","filePath":"list/单片机/miot-plugin-sdk-npminstall安装失败.md","lastUpdated":1701435297000}'),o={name:"list/单片机/miot-plugin-sdk-npminstall安装失败.md"},i=t(`<h1 id="miot-plugin-sdk-npm-install安装失败" tabindex="-1">miot-plugin-sdk-npm install安装失败 <a class="header-anchor" href="#miot-plugin-sdk-npm-install安装失败" aria-label="Permalink to &quot;miot-plugin-sdk-npm install安装失败&quot;">​</a></h1><p>最紧公司要开发一台智能设备，经过同事的对比，选中了米家作为云平台，于是，我就负责开发app界面端，根据官方文档教程 下载了miot-plugin-sdk 程序，准备开始开发……</p><h3 id="初始化" tabindex="-1">初始化 <a class="header-anchor" href="#初始化" aria-label="Permalink to &quot;初始化&quot;">​</a></h3><pre><code>1, 下载开发环境, 执行 
...
( **推荐mac上：npm版本6.12.1，node版本v12.13.1** )
   ...
   \`\`\`bash
   bin/install_mihome_dev.bat //（注意按提示关闭实时安全防护)
   \`\`\` 
   MacOS: 执行 
...
\`\`\`
</code></pre><h3 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h3><p>在项目创建后(如xxx.yyy.zzz), 在projects/xxx.yyy.zzz 目录下有项目配置文件 project.json, 结构说明如下:</p><pre><code>\`\`\`js
{
...
</code></pre><h2 id="遇到问题" tabindex="-1">遇到问题 <a class="header-anchor" href="#遇到问题" aria-label="Permalink to &quot;遇到问题&quot;">​</a></h2><p>npm install 怎么也安装不成功，一直报错。百度了无数答案，始终没有找到好的解决办法。于是，直接阅读文档，终于在官方的文档里找到原因了。</p><h2 id="官方解答" tabindex="-1">官方解答： <a class="header-anchor" href="#官方解答" aria-label="Permalink to &quot;官方解答：&quot;">​</a></h2><p><img src="https://iot.mi.com/v2/new/doc/plugin/quickstart/quick-start" alt="说明"></p><pre><code>如果使用 npm 安装报错，可尝试 设置 npm 淘宝镜像 或使用搜索引擎搜索解决方案;
...
</code></pre>`,22),s=[i];function l(p,r,m,c,d,x){return e(),a("div",null,s)}const _=n(o,[["render",l]]);export{u as __pageData,_ as default};
